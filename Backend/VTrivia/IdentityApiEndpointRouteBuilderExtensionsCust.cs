...
/// </summary>
public static class IdentityApiEndpointRouteBuilderExtensionsCust
{
    ...
    public static IEndpointConventionBuilder MapIdentityApiCust<TUser>(this IEndpointRouteBuilder endpoints)
        where TUser : class, new()
    {
            ...
            ([FromBody] RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            {
                throw new NotSupportedException($"{nameof(MapIdentityApiCust)} requires a user store with email support.");
            }
        ...
        .Add(endpointBuilder =>
        {
            ...
            confirmEmailEndpointName = $"{nameof(MapIdentityApiCust)}-{finalPattern}";
