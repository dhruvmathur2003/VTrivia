...
namespace VTrivia.Migrations
{
    ...
    [Migration("20240301101048_addedQuizModel")]
    partial class addedQuizModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VTrivia.Model.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppUserGroup", b =>
                {
                    b.HasOne("VTrivia.Model.AppUser", null)
                        .WithMany()
                        .HasForeignKey("AppUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VTrivia.Model.Group", null)
                        .WithMany()
